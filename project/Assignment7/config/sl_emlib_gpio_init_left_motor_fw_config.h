#ifndef SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_CONFIG_H
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW
// $[GPIO_SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW]
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_PORT    gpioPortC
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_PIN     6
// [GPIO_SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_CONFIG_H
