#ifndef SL_EMLIB_GPIO_INIT_PIN_A_2_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_A_2_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_A_2_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_A_2_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PIN_A_2_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_A_2_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_A_2
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_A_2]
#define SL_EMLIB_GPIO_INIT_PIN_A_2_PORT          gpioPortC
#define SL_EMLIB_GPIO_INIT_PIN_A_2_PIN           6
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_A_2]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_A_2_CONFIG_H
