#ifndef SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_CONFIG_H
#define SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL
// $[GPIO_SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL]
#define SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_PORT gpioPortD
#define SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_PIN 2
// [GPIO_SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_RIGHT_LED_CONTROL_CONFIG_H
