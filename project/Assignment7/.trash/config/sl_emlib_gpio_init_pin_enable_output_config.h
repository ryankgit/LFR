#ifndef SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT]
#define SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_PORT gpioPortC
#define SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_PIN 3
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_ENABLE_OUTPUT_CONFIG_H
