#ifndef SL_EMLIB_GPIO_INIT_PIN_B_2_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_B_2_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_B_2_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_B_2_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PIN_B_2_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_B_2_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_B_2
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_B_2]
#define SL_EMLIB_GPIO_INIT_PIN_B_2_PORT          gpioPortB
#define SL_EMLIB_GPIO_INIT_PIN_B_2_PIN           3
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_B_2]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_B_2_CONFIG_H
