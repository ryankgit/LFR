#ifndef SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_CONFIG_H
#define SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT
// $[GPIO_SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT]
#define SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_PORT gpioPortB
#define SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_PIN 1
// [GPIO_SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_RIGHT_SENSOR_INPUT_CONFIG_H
