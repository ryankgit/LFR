#ifndef SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_CONFIG_H
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW
// $[GPIO_SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW]
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_PORT gpioPortB
#define SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_PIN  3
// [GPIO_SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_LEFT_MOTOR_FW_BW_CONFIG_H
